...
figure1=figure('NumberTitle','off','Name','Visualization of the Profile 1: Regularly Increasing');
profile=plot(par_vel,par_dpt,'r-','LineWidth',1,'MarkerFaceColor','g');
...
figure2=figure('NumberTitle','off','Name','Profile 1: Regular Increasing');
axes1=axes('Parent',figure2);
box(axes1,'on');hold(axes1,'on');
[MS,NS]=size(LoveDCs);
for p=1:NS
    plt=plot(ISFREQ:IEFREQ,LoveDCs(:,p));hold on
    title('Multimode Love Wave Dispersion Curves of Profile 1')
    xlabel('Frequency [Hz]')
