...
figure1=figure('NumberTitle','off','Name','Visualization of the Profile 2: Regularly Decreasing');
...
figure1=figure('NumberTitle','off','Name','Profile 2: Regular Decreasing');
axes1=axes('Parent',figure1);
box(axes1,'on');hold(axes1,'on');
[MS,NS]=size(LoveDCs);
for p=1:NS
    plt=plot(ISFREQ:IEFREQ,LoveDCs(:,p));hold on
    title('Multimode Love Wave Dispersion Curves of Profile 2')
    xlabel('Frequency [Hz]')
